<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="200" height="200"
    ...
    <g>
      <circle cx="84" cy="50" r="10" fill="#d6d6d6">
        ...
        <animate attributeName="fill" repeatCount="indefinite" dur="1s" calcMode="discrete" keyTimes="0;0.25;0.5;0.75;1"
          values="#d6d6d6;#d6d6d6;#d6d6d6;#d6d6d6;#d6d6d6" begin="0s"></animate>
      </circle>
      <circle cx="16" cy="50" r="10" fill="#d6d6d6">
      ...
      <circle cx="50" cy="50" r="10" fill="#d6d6d6">
        <animate attributeName="r" repeatCount="indefinite" dur="1s" calcMode="spline" keyTimes="0;0.25;0.5;0.75;1"
